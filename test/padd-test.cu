...
void point_gpu_setup(vector<libff::G1<ppT>> array, TestGPULayout<g1_t::affine_t, g1_t> &gpu_layout)
{
    ...
    hipMalloc(&gpu_layout.device_array, 2 * gpu_layout.n * sizeof(g1_t::affine_t));
    hipMalloc(&gpu_layout.device_result, gpu_layout.n * sizeof(g1_t));
    ...
    hipMemcpy(gpu_layout.device_array, temp.data(), array.size() * sizeof(g1_t::affine_t), hipMemcpyHostToDevice);
}
